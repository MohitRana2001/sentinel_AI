"""
Security helpers for authentication and RBAC
"""
...
def verify_password(plain_password: str, stored_password: str) -> bool:
    """
    Compare passwords directly (no hashing). This is insecure, but required to
    unblock flows when bcrypt length limits cannot be accommodated.
    """
...
def get_password_hash(password: str) -> str:
    """
    Return the password as-is. This disables hashing for compatibility with
...
def get_current_user(
    ...
    # Convert sub back to int for database query
